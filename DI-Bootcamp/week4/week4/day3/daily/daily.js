...
// function getCarHonda(data) {
//     const firstHonda = data.find(car => car.car_make === "Honda");
...
function sortCarInventoryByYear(carsYear){
    const result = carsYear.sort((a,b) => (a.car_year > b.car_year ? 1 : -1))
    console.log(result);
}
